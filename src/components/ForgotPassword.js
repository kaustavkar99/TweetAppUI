      ...
      >
        {({
          ...
          <Form
            ...
            style={{backgroundColor:'#F1F1F1',borderRadius:'25px',padding:'20px'}}
          >
            <Row className="mb-3">
              <Form.Group as={Col} md="12" controlId="signInEmail">
                <Form.Label style={{fontWeight:"bold"}}>Username(Email)</Form.Label>
                <Form.Control
                  type="email"
                  name="userName"
            ...
            <Row className="mb-3">
              <Form.Group as={Col} md="12" controlId="signInPassword1">
                <Form.Label style={{fontWeight:"bold"}}>ReEnter Password</Form.Label>
                <Form.Control
                  type="password"
                  name="password1"
